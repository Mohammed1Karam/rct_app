...
class FilterOwnershipScreen extends StatefulWidget {
  const FilterOwnershipScreen({super.key});

  @override
  State<FilterOwnershipScreen> createState() => _FilterScreenState();
}

class _FilterScreenState extends State<FilterOwnershipScreen> {
  String selectedCity = "";
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                children: [
                  MainButton(
                    ...
                    onTap: () {
                      ...
                      // context.read<RentersCubit>().filterData(
                      //   city: selectedCity,
                      ...
                      context.read<RentersCubit>().filterProperties(city: selectedCity, district: distrectnameController.text, maxPrice: selectedPrice);
                    },
                  ),
                  MainButton(
                    width: 150,
              ...
              BlocListener<RentersCubit, RentersState>(
                listener: (context, state) {
                  if (state is FilterSuccessState) {
                    Navigator.pop(context);
                  } else if (state is GetRenterError) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content:
