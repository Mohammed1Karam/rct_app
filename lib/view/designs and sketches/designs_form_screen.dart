...
class DesignsForm extends StatefulWidget {
  final dynamic id;
  final dynamic price;
  DesignsForm({super.key, required this.id, required this.price});
...
class _DesignsFormState extends State<DesignsForm> {
  ...
  Future<void> _submitOrder() async {
    ...
    _noOrderNumber
        ? context.read<FinalOrdersCubit>().PostDesignhWithoutOrderNum(
              id: widget.id.toString(),
              price: widget.price.toString(),
            )
        : await context.read<FinalOrdersCubit>().PostDes(context);
    ;
  }
